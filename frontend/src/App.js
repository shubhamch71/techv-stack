...
// ✅ CHANGE 1: Replace hardcoded env with relative path
const SERVER_URL = '/api/employees';
    ...
    async function createEmployee() {
        await axios.post(SERVER_URL, {
            ...
            .catch(function (error) {
                console.log(`error adding employee${JSON.stringify(error)}`);  // ✅ CHANGE 2: Fix typo
            });
